...
import { PredictionTrends } from "@/components/dashboard/PredictionTrends";
import { PersonalNoiseAnalyzer } from "@/components/dashboard/PersonalNoiseAnalyzer";
  ...
  return (
    <div className="min-h-screen bg-gradient-data">
      ...
      <main className="container mx-auto px-6 py-8 space-y-8">
        {/* Personal Noise Analyzer */}
        <section>
          <PersonalNoiseAnalyzer />
        </section>
